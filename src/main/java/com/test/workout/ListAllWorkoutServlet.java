...
@WebServlet(urlPatterns = "/list-workouts.do")
public class ListAllWorkoutServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		request.setAttribute("workouts", workoutDao.getAllWorkouts());
		request.setAttribute("personalWorkouts", pwoDao.getAllPersonalWorkouts(request.getSession().getAttribute("name").toString()));
		request.setAttribute("allworkoutsnum", workoutDao.getAllWorkouts().size());
